  ...
  return (
    <div className={clsx("flex flex-col items-center justify-between w-full max-h-full p-10 mx-auto max-w-7xl px-6 pb-32 pt-20 sm:pt-32 lg:px-8 lg:pt-10")}>
      <div>
        ...
        <p className="pt-4">Explore parks, cafes, and shops that welcome your furry friends.</p>
      </div>
      <div>
        <div className="flex gap-12 justify-between w-full pt-14">
          <div className="flex flex-col gap-2 justify-center items-center">
            ...
            <p className="pt-4">Find the best parks for your dog to play and socialize.</p>
          </div>
          <div className="flex flex-col gap-2 justify-center items-center">
            <div className="flex flex-col justify-center items-center text-2xl font-semibold tracking-tight text-slate-900">
            ...
            <p className="pt-4">Enjoy a coffee while your dog gets a treat.</p>
          </div>
          <div className="flex flex-col gap-2 justify-center items-center">
            <div className="flex flex-col justify-center items-center text-2xl font-semibold tracking-tight text-slate-900">
            ...
            <p className="pt-4">Get everything your dog needs from trusted pet shops.</p>
          </div>
        </div>
      </div>
    </div>
