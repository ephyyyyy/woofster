...
export const ServiceExplanation = () => {
  return (
    <div className={clsx("flex flex-col items-center justify-between w-full max-h-full mx-auto max-w-7xl mt-48 mb-6")}>
      <div>
        <h2 className="text-4xl font-bold tracking-tight text-slate-900">Discover Dog-Friendly Places</h2>
        <p className="pt-2 text-theme-gray_text">Explore parks, cafes, and shops that welcome your furry friends.</p>
      </div>
      <div>
        <div className="flex gap-12 justify-between w-full pt-14">
          <div className="flex flex-col gap-2 justify-center items-center">
            <div className="flex flex-col justify-center items-center text-2xl font-semibold tracking-tight text-slate-900">
              ...
              <span className="mt-2">Top-Rated Parks</span>
            </div>
            <p className="pt-2 text-theme-gray_text">Find the best parks for your dog to play and socialize.</p>
          </div>
          <div className="flex flex-col gap-2 justify-center items-center">
            <div className="flex flex-col justify-center items-center text-2xl font-semibold tracking-tight text-slate-900">
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="mug-saucer" className="w-10 h-10" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path fill="currentColor" d="M96 64c0-17.7 14.3-32 32-32H448h64c70.7 0 128 57.3 128 128s-57.3 128-128 128H480c0 53-43 96-96 96H192c-53 0-96-43-96-96V64zM480 224h32c35.3 0 64-28.7 64-64s-28.7-64-64-64H480V224zM32 416H544c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32z"></path></svg>
              <span className="mt-2">Dog-Friendly Cafes</span>
            </div>
            <p className="pt-2 text-theme-gray_text">Enjoy a coffee while your dog gets a treat.</p>
          </div>
          <div className="flex flex-col gap-2 justify-center items-center">
            <div className="flex flex-col justify-center items-center text-2xl font-semibold tracking-tight text-slate-900">
              ...
              <span className="mt-2">Pet Shops</span>
            </div>
            <p className="pt-2 text-theme-gray_text">Get everything your dog needs from trusted pet shops.</p>
          </div>
        </div>
      </div>
    </div>
