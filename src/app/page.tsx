...
const MapPreviewSide = () => {
  return (
    <div className="flex justify-between items-start w-full mt-48 mb-6 gap-28">
      <div className="flex flex-col justify-center items-start w-3/5">
        <h2 className="z-10 text-3xl font-bold tracking-tight text-slate-900">Explore the World with Your Pet</h2>
        <p className="pt-2 ml-1 text-theme-gray_text tracking-tight">Use our map to discover best places and services for dogs, and enhance your pet&apos;s life with us.</p>
